 ...
 */
package com.momo.live.dubbo.common.json;

import com.momo.live.dubbo.common.bytecode.Wrapper;
...
class J2oVisitor implements JSONVisitor
{
	...
	private com.momo.live.dubbo.common.utils.Stack<Object> mStack = new com.momo.live.dubbo.common.utils.Stack<Object>();
	...
	private static Object toArray(Class<?> c, com.momo.live.dubbo.common.utils.Stack<Object> list, int len) throws ParseException
	{
		if( c == String.class )
		{
			if( len == 0 )
